...
function visibleFalse(obj,i,name){
	...
	if(i==1){
		model.traverse((child) => {
		    if (child.isMesh && child.material) {
				 if(child.name.indexOf('立方体076')!==-1){ //obj.name){ //模糊匹配去掉第5层的屋顶//child.name.indexOf('立方体076')!==-1 
				 console.log(child)
